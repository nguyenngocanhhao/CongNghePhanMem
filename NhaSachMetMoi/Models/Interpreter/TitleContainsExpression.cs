...
{
    public class TitleContainsExpression : IExpression
    {
        private readonly string _keyword;
        private IExpression _next;

        public TitleContainsExpression(string keyword)
        {
        ...
        {
            books = books.Where(b => RemoveDiacritics(b.TenSach).Contains(_keyword)).ToList();
